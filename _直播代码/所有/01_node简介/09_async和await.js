...
*/
async function fn2() {
    //即使你不写return 也是返回一个promise 只不过result的值是undefined
    return 10
}
...
async function fn3() {
    ...
    // then 的源码 当返回新的promise的时候用新的promise替代原本的promise
    // then<TResult1 = T, TResult2 = never>(onfulfilled?: ((value: T) =>
    // TResult1 | PromiseLike<TResult1>) | undefined | null, onrejected?: ((reason: any) =>
    // TResult2 | PromiseLike<TResult2>) | undefined | null): Promise<TResult1 | TResult2>;
